...
build-$1:
ifeq ($(do_default),true)
	$(DOCKER) build --pull --build-arg PGIS_API_VERSION=v1 -t $(REPO_NAME)/$(IMAGE_NAME):$(shell echo $1) $1
endif
ifeq ($(do_alpine),true)
ifneq ("$(wildcard $1/alpine)","")
	$(DOCKER) build --pull --build-arg PGIS_API_VERSION=v1 -t $(REPO_NAME)/$(IMAGE_NAME):$(shell echo $1)-alpine $1/alpine
endif
endif
endef
